...
# EV Gap Strategy
# ─────────────────────────────────────────────
EV_MIN_GAP = 0.08              # 8% minimum gap - live-proven sweet spot (100% win rate)
...
# ─────────────────────────────────────────────
LIVE_TRADE_AMOUNT_USD = 4.00   # Exact dollar amount (USDC) to bet per trade
LIVE_DRY_RUN = False           # LIVE mode - real trades on Polygon mainnet
# Logging
# ─────────────────────────────────────────────
